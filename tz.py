"""
Нам необходимо разработать интернет-ресурс для фанатского сервера одной известной MMORPG — что-то вроде
доски объявлений.
...
"""
Для того, чтобы на странице профиля отображались посты только текущего пользователя, 
вам нужно в представлении UserView в методе get_queryset фильтровать объекты модели Comment по полю author.
"""